...
std::set<sf::Keyboard::Key> KeyAndMouseManager::keysPressed;
std::set<sf::Keyboard::Key> KeyAndMouseManager::keysDown;
std::set<sf::Keyboard::Key> KeyAndMouseManager::keysReleased;

std::set<sf::Mouse::Button> KeyAndMouseManager::mouseButtonsPressed;
std::set<sf::Mouse::Button> KeyAndMouseManager::mouseButtonsDown;
std::set<sf::Mouse::Button> KeyAndMouseManager::mouseButtonsReleased;

bool KeyAndMouseManager::focus(true);
vec2i KeyAndMouseManager::lastMousePos(0,0);
vec2i KeyAndMouseManager::mouseDisplacement(0,0);

KeyAndMouseManager::KeyAndMouseManager() {
}

KeyAndMouseManager::~KeyAndMouseManager() {
}

void KeyAndMouseManager::update(bool &isGameRunning, sf::Window &window) {
...
void KeyAndMouseManager::setMousePos(int x, int y, sf::Window& window) {
